...
$arguments = [
    ...
    'skip' =>           ['S', Configurator::SET, 'skip types', 'types', DatabaseDumper::TYPES],
    ...
    'formatViews' =>    ['', Configurator::FLAG, 'pretty view formatting'],
        'Input/Output:',
    'fileStructure' =>  ['f', Configurator::ENUM, 'create output file per...', 'type', ['object', 'database', 'single']],
    ...
    'short' =>          ['s', Configurator::FLAG, 'short console output (no newlines)'],
