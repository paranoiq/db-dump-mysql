...
require __DIR__ . '/src/Dumper/Input/InputAdapter.php';
require __DIR__ . '/src/Dumper/Input/FileInputAdapter.php';
require __DIR__ . '/src/Dumper/Output/OutputAdapter.php';
require __DIR__ . '/src/Dumper/Output/FileOutputAdapter.php';
